...
//  CustomAlert
//
//  Created by 石戸朋哲 on 2019/05/16.
//  Copyright © 2019 石戸朋哲. All rights reserved.
//

import UIKit

enum CarouselModalError: Error {
  case noContents
  case failedToInitModalPageVc
}

class CarouselModal: UIViewController {
  // arguments
  ...
  public convenience init(title: String, images: [UIImage], descriptions: [String]) throws {
    ...
    do {
      ...
      throw CarouselModalError.failedToInitModalPageVc
    }
